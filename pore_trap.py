...
parser.add_argument('--Rp', default=1.0, type=float, help='pore radius, default 1.0 um')
parser.add_argument('--rc', default=1.0, type=float, help='cut off in um for regularisation, default 1.0 um')
